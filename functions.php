...
function underscoresass_setup() {
	...
	register_nav_menus( array(
		'primary' => esc_html__( 'Primary', 'underscoresass' ),
	) );
...
function underscoresass_scripts() {
	...
	wp_enqueue_script( 'underscoresass-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20151215', true );

	wp_enqueue_script( 'underscoresass-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20151215', true );
