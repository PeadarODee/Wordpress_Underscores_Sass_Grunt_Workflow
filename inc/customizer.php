<?php
/**
 * Sassy Underscores Theme Customizer.
 *
...
function underscoresass_customize_preview_js() {
	wp_enqueue_script( 'underscoresass_customizer', get_template_directory_uri() . '/js/customizer.js', array( 'customize-preview' ), '20151215', true );
}
